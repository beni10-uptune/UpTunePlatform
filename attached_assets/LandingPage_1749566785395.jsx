        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <p className="text-sm text-gray-500">
              No signup required • Works with Spotify • 100% Free Forever
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <div className="flex items-center space-x-2">
              ...
              <span className="font-semibold text-gray-800">Uptune</span>
            </div>
            
            <div className="flex items-center space-x-6 text-sm text-gray-600">
              <button onClick={handleTeamsInterest} className="hover:text-purple-600 transition-colors">
                Uptune for Teams
              </button>
              <button onClick={() => navigate('/challenge')} className="hover:text-purple-600 transition-colors">
                Weekly Challenge
              </button>
            </div>
          </div>
          ...
          <div className="mt-8 pt-8 border-t text-center text-sm text-gray-500">
            <p>Turn music into connection. Made with ❤️ for bringing people together.</p>
          </div>
        </div>
      </footer>
    </div>
